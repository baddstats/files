...
std::list<std::list<std::list<std::vector<bool>>>> scsg2_cpp_nested(List nn,
                                                             IntegerMatrix w,
                                                             IntegerVector idx,
                                                             unsigned int nlevel,
                                                             NumericVector lprimes) {
  ...
  // list of zones
  std::list<std::list<std::list<std::vector<bool>>>> z;
  ...
  for (i = 0; i < nidx; i++) {
    ...
    z.emplace_back(std::move(zidx));
  }
  return z;
}

// [[Rcpp::export]]
std::list<std::list<std::vector<bool>>> scsg3_cpp(List nn,
                                              IntegerMatrix w,
                                              IntegerVector idx,
                                              unsigned int nlevel,
                                              NumericVector lprimes) {
